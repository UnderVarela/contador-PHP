...
class Ejecutable {
  public static function main() {
    ...
    $password1 = new Password(10);
    $password2 = new Password();

    // Mostrar las contraseñas y si son fuertes o no
    echo "Contraseña1: " . $password1->getContraseña() . " es " . ($password1->esFuerte() ? "fuerte" : "débil") . "\n";
    echo "Contraseña2: " . $password2->getContraseña() . " es " . ($password2->esFuerte() ? "fuerte" : "débil") . "\n";
  }
}
